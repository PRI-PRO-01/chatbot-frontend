  ...
  return (
    <>
      <div className='homePage'>
        ...
        <button onClick={handleOpenModal} className='bg-gradient-to-r from-blue-500 to-pink-500 bg-clip-text text-transparent mt-10 p-5 text-3xl rounded-2xl border hover:font-extrabold'>
          Prueba el Chatbot
        </button>
        ...
        <Modal isOpen={isModalOpen} onClose={handleCloseModal}>
          <div className='max-w-3xl'>
            ...
            <form onSubmit={handleSubmit} action={'./dashboard/conversations'}>
              ...
              <button className='bg-gray-500 w-full border rounded-2xl text-3xl p-2 hover:bg-blue-500 transition duration-300 ease-in-out' type='submit'>
                Continuar
              </button>
            </form>
          </div>
